    ...
    case 'spotify':
      return (
        <svg 
          ...
          className={className}
        >
          <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.02.24-2.82-1.74-6.36-2.1-10.56-1.14-.42.06-.84-.18-.9-.6-.06-.42.18-.84.6-.9 4.56-.96 8.52-.54 11.64 1.38.3.18.42.6.24.96-.06.06-.06.06 0 0zm1.5-3.3c-.3.42-.84.6-1.26.3-3.24-1.98-8.16-2.58-11.94-1.44-.48.12-.96-.12-1.08-.6-.12-.48.12-.96.6-1.08 4.38-1.32 9.78-.66 13.5 1.62.36.24.48.78.18 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.3c-.6.18-1.2-.18-1.38-.78-.18-.6.18-1.2.78-1.38 4.2-1.26 11.28-1.02 15.9 1.74.54.3.72 1.02.42 1.56-.3.48-.96.72-1.5.42z"/>
        </svg>
      );
    default:
      return (
